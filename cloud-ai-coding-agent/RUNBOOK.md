...
Docker Desktop must be running. On Windows, ensure Linux containers and socket sharing work. Host Java 21 is optional for Compose but required for direct Maven tests. Never respond to endpoint protection by adding exclusions.
