...
| [`WebServer.java`](./src/main/java/org/chijai/WebServer.java) | Entry point | WebServer bootstraps the process and wires the runtime. Key methods: `main()`. |
