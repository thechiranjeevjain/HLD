...
public class PreTradeRiskEngine {
    ...
    public synchronized EngineState reset() {
        ...
        accounts.put("NASDAQ-DEMO", new AccountRisk(ACCOUNT_BUYING_POWER));
    ...
    private ScenarioResult acceptedScenario() {
        reset();
        OrderDecision decision = submit(new OrderRequest("ACC-1001", "NASDAQ-DEMO", "MSFT", Side.BUY, 100,
    ...
    private ScenarioResult rejectedScenario() {
        reset();
        OrderDecision decision = submit(new OrderRequest("REJ-1001", "NASDAQ-DEMO", "MSFT", Side.BUY, 20_000,
                new BigDecimal("410.25"), false));
        return new ScenarioResult(
                "reject",
    ...
    private ScenarioResult killSwitchScenario() {
        reset();
        setKillSwitch(new KillSwitchRequest("ACCOUNT", "NASDAQ-DEMO", true, "desk kill switch test"));
        OrderDecision decision = submit(new OrderRequest("KILL-1001", "NASDAQ-DEMO", "MSFT", Side.BUY, 100,
                new BigDecimal("410.25"), false));
        return new ScenarioResult(
                "kill",
    ...
    private ScenarioResult failureScenario() {
        ...
        OrderDecision decision = submit(new OrderRequest("FAIL-1001", "NASDAQ-DEMO", "MSFT", Side.BUY, 100,
                new BigDecimal("410.25"), false));
        return new ScenarioResult(
                "failure",
    ...
    private ScenarioResult pnlScenario() {
        reset();
        OrderDecision decision = submit(new OrderRequest("PNL-1001", "NASDAQ-DEMO", "MSFT", Side.BUY, 100,
    ...
    private Callable<OrderDecision> racingOrder(CountDownLatch start, String clOrdId) {
        return () -> {
            ...
            return submit(new OrderRequest(clOrdId, "NASDAQ-DEMO", "MSFT", Side.BUY, 1700,
                    new BigDecimal("410.25"), false));
        };
    }
