...
Runnable single-service demo for explaining a Nasdaq-style pre-trade risk engine.
...
Invoke-RestMethod -Method Post `
  ...
  -Body '{"clOrdId":"JSON-1001","account":"NASDAQ-DEMO","symbol":"MSFT","side":"BUY","quantity":100,"price":410.25,"autoFill":false}'
```
...
Invoke-RestMethod -Method Post `
  ...
  -ContentType 'application/json' `
  -Body '{"message":"8=FIX.4.4|35=D|11=FIX-1001|1=NASDAQ-DEMO|55=MSFT|54=1|38=100|40=2|44=410.25|10=000|"}'
```
