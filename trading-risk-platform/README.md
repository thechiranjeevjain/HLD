...
For a focused live interview demo of a venue-neutral pre-trade flow, use the standalone `pretrade-risk-engine` module. It runs on port `8090` and includes a browser dashboard, FIX parser, in-memory risk state, atomic reservation, kill switch, circuit breaker, audit trail, race-condition demo, and real-time P&L.
